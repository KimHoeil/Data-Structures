...

{
    ...
    if (tree1->item == tree2->item)
    {
        ...
        // 구조가 동일한지 재귀적으로 탐색
        checkLeft = identical(tree1->left, tree2->left);
        checkright = identical(tree1->right, tree2->right);
