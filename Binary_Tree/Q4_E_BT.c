...

{
    ...
    {
        leftSumOfOdd = sumOfOddNodes(node->left);
        rightSumOfOdd = sumOfOddNodes(node->right);

        sumOfOdd = node->item + leftSumOfOdd + rightSumOfOdd;
    }
    else
    {
        leftSumOfOdd = sumOfOddNodes(node->left);
        ...
        sumOfOdd = leftSumOfOdd + rightSumOfOdd;
    }

    // printf("sum %d leftsum %d rightsum %d\n", sumOfOdd, leftSumOfOdd, rightSumOfOdd);
